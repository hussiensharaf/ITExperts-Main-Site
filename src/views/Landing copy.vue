      ...
      <v-col cols="12">
        ...
        <v-row no-gutters justify="center" class="sol-row">
          <v-col
            ...
            lg="3"
            sm="12"
            v-for="(sol, index) in this.solutionsData"
            :key="index"
          >
            <v-card
              align="center"
              class="sol-card grey lighten-5 ma-6 pa-5"
              min-height="55vh"
              max-width="500px"
              flat
            >
          ...
          <v-col class="px-16 py-16" cols="12" xl="6" lg="6" sm="12">
            ...
            <v-row class="white--text pt-7 flex-nowrap justify-start  align-start">
              ...
              <a href="mailto:dr.sharaf@from-masr.com"
                ><h4>dr.sharaf@from-masr.com</h4></a
              >
            </v-row>
...
.k-in-t-btn {
  ...
  background: linear-gradient(
    ...
    rgba(8, 8, 109, 1) 20%,
    rgba(0, 212, 255, 1) 10%,
    rgba(2, 0, 36, 0.8743872549019608) 100%
  ) !important;
...
.v-window-y-reverse-transition-leave-active {
  ...
  transition: 1.5s cubic-bezier(0.7, 0.3, 0.5, 1) !important; /*slow then fast */
